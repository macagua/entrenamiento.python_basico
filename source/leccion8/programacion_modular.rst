...
Para utilizar la programación modular en Python, se pueden seguir los siguientes pasos:


**1) Uso de módulos de la librería estándar**
...
**2) Creación de un módulo en Python**
...
**3) Importar una función en otro módulo**
